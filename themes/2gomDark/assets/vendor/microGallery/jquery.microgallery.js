			...
			addNav : function() {
				$slidewrap.each(function(i) {
					var $oEl = $(this),
						...
						navMarkup = [
							'<div class="slidecontrols" role="navigation">',
							'	<div role="presentation" class="prev"><a href="#' + currentSlider + '" class="' + opt.namespace + '-prev"><span class="icon wb-chevron-left"></span></a></div>',
							'	<div role="presentation" class="next"><a href="#' + currentSlider + '" class="' + opt.namespace + '-next"><span class="icon wb-chevron-right"></span></a></div>',
							'</div>'
							].join(''),
						nextprev = {
