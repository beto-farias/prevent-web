				...
				<div>
                 ...
                 <?php
                  ...
                  <?php
                    ...
                    <span class="site-menu-title">Judge Progresss</span>', array (
...
echo CHtml::link ( '<i class="site-menu-icon wb-share" aria-hidden="true"></i>
								<span class="site-menu-title">Finalist</span>', array (
								"juecesAdmin/finalists" 
						), array (
								"class" => "animsition-link" 
						) );
						?>
						...
						<li class="site-menu-item">
							<!--                   <a class="animsition-link" href="#"> --> <!--                     <i class="site-menu-icon wb-dashboard" aria-hidden="true"></i> -->
							<!--                     <span class="site-menu-title">Competitors</span> -->
							<!--                   </a> -->
						<?php echo CHtml::link('<i class="site-menu-icon wb-hammer" aria-hidden="true"></i><span class="site-menu-title">Category conflicts</span>',array('juecesAdmin/conflicts')); ?>
                </li>
