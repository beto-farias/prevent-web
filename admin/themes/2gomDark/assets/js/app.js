...
(function(document, window, $) {
  ...
  window.App = Site.extend({
    handleSlidePanel: function() {
      ...
      $(document).on('click', '[data-toggle=sfgsdlidePanel]', function(e) {
        $.slidePanel.show({
          url: $(this).data('url'),
          settings: {
            cache: false
...
function editarEventoFunction(element){
...
function viewDetallesEvento(elemento){
...
function deleteMultimedia(elemento){
var url = elemento.data("url");
	...
	swal({
	      ...
	      .done(function(data) {
	    	  $.fn.yiiListView.update("listaEventos");
	    	  elemento.parent().remove();
	        swal("Eliminado", "El archivo fue eliminado exitosamente.", "success");
	      })
	      .error(function(data) {
	        swal("Error", "Hay un problema con la conexión al servidor.", "error");
	      });
	    });
	
}

function deleteEvento(elemento){
	var url = elemento.data("url");
	...
	swal({
	      ...
	      .done(function(data) {
	    	  $.fn.yiiListView.update("listaEventos");
	        swal("Eliminado", "El evento ha sido eliminado exitosamente", "success");
	      })
	      .error(function(data) {
	        swal("Error", "Hay un problema con la conexión al servidor.", "error");
	      });
